...
| total_time      | float64            | [0;1]               | Time difference between task5_end and start_time                                                         |
...
| task1_time_diff | float64            | [0;1]               | Time difference between task1_end and task1_start  in seconds                                            |
...
| task2_time_diff | float64            | [0;1]               | Time difference between task2_end and task2_start  in seconds                                            |
...
| task3_time_diff | float64            | [0;1]               | Time difference between task3_end and task3_start  in seconds                                            |
...
| task4_time_diff | float64            | [0;1]               | Time difference between task4_end and task4_start in seconds                                             |
...
| task5_time_diff | float64            | [0;1]               | Time difference between task5_end and task5_start  in seconds                                            |
...
| post_RV2        | int64              | {1;2;3;4;5}         | I my opinion, the tasks I performed represent skills that are required in   real incident repsonse work. |
